...
class DiscordConverterTest extends TestParamConverterCase
{
    ...
    public function provideApplyConfigurations()
    {
        ...
        yield ['class' => $this->gm(Role::class), 'className' => Role::class, 'name' => 'roleId', 'value' => $this->faker->snowflake(), 'responseClass' => Role::class, 'responseMethod' => 'getId'];
        yield ['class' => $this->gm(Channel::class), 'className' => Channel::class, 'name' => 'channelId', 'value' => $this->faker->snowflake(), 'responseClass' => Channel::class, 'responseMethod' => 'getId'];
