...
class GetCommandsPermissionsTest extends TestDiscordBotClientCase
{
     ...
     */
    public function testGetCommandsPermissions()
    {
        /** @var GuildApplicationCommandPermission[] $response */
        $response = $this
            ->setupResponse('HttpClient/get-commands-permissions-success.json', type: '\Bytes\DiscordResponseBundle\Objects\Slash\GuildApplicationCommandPermission[]')
            ->deserialize();
